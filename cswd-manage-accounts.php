...
<body>
	...
	<div class="container cswd-container">
		<div class="row">
			<ol class="breadcrumb breadcrumb-arrow">
			  <li><a href="cswd-account-dashboard.php">Dashboard</a></li>
     		  <li class="active"><span>Manage Accounts</span></li>
			</ol>
			    	...
			    	<div class="panel-body">
			    		<div class="row">
			    			<div class="col-xs-12 col-md-6">
			    				<div class="panel panel-default cswd-panel" id="cswd-add-accounts">
									<div class="panel-body">
								  		<h4><span class="glyphicon glyphicon-pencil"></span> Create Account</h4>
								  	</div>
								</div>
			    			</div>
			    			<div class="col-xs-12 col-md-6">
			    				<div class="panel panel-default cswd-panel" id="cswd-view-accounts">
									<div class="panel-body">
								  		<h4><span class="glyphicon glyphicon-user"></span> View Accounts</h4>
								  	</div>
								</div>
			    			</div>
			    		</div>
	...
	<script type="text/javascript">
		...
		$( "#cswd-add-accounts" ).click(function() {
		  window.location.assign('cswd-add-accounts.php');
		});

		$( "#cswd-view-accounts" ).click(function() {
		  window.location.assign('cswd-view-accounts.php');
		});
