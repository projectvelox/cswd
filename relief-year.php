...
<body onload="start()" style="height: auto;">
	...
	<h3 class="text-center">Relief Operations for the Year of <?php echo $_GET['year']; ?> Reports</h3>
	<div class="table-responsive">
		<table class="table">
		  	...
		  	<?php
				...
				$sql = "SELECT DATE_FORMAT(delivery_ended, '%M %D, %Y %h:%i %p') AS delivery_endeds, DATE_FORMAT(delivery_started, '%M %D, %Y %h:%i %p') AS delivery_starteds, cswd_create_relief.* FROM cswd_create_relief WHERE YEAR(delivery_ended)= '$year'";
		...
		<br><br><p class="text-center"><i>List of relief operations for the year of <?php echo $_GET['year'];  ?></i></p>
