		...
		<div class="row">
			<ol class="breadcrumb breadcrumb-arrow">
			  ...
			  <li><a href="cswd-reports.php">Reports</a></li>
     		  <li class="active"><span>Detailed Relief Operation</span></li>
			</ol>

			<div class="cswd-header">
				<h1>Detailed Relief Operations</h1>
			</div>
			    		...
			    		<div class="row">
			    			...
			    			<?php 
								...
								foreach ($result as $row){
									echo '
										<div class="col-xs-12 col-md-3"><a href="relief-year.php?year='.$row['delivery_ended'].'" style="color: #000; text-decoration: none;" target="_blank">
			    	...
			    	<div class="panel-body">
			    		<div class="row">
			    			...
			    			<?php 
								...
								foreach ($result as $row){
									echo '
										<div class="col-xs-12 col-md-3"><a href="relief-month.php?month='.$row['delivery_ended'].'" style="color: #000; text-decoration: none;" target="_blank">
						    				<div class="panel panel-default cswd-panel" id="cswd-manage-evacuation">
												<div class="panel-body">
											  		<h5><strong><span class="glyphicon glyphicon-list-alt"></span> Reports from '. $row['delivery_ended'] .'</strong></h5>
											  	</div>
											</div></a>
						    			</div>
									';
